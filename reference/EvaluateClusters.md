...
#> Clustering for Euclidean complete after 6.15 secs total.

#> Clustering for Spearman complete after 6.16 secs total.

#> Clustering for SED complete after 6.16 secs total.
#> Consensus clustering complete after 6.2 secs total.
