...
#> Euclidean t-SNE calculation complete after 3.9 secs total.
#> Combined distance calculation complete after 3.9 secs total.
#> SED t-SNE calculation complete after 5.72 secs total.

#> Clustering for Euclidean complete after 6.88 secs total.

#> Clustering for Spearman complete after 6.89 secs total.

#> Clustering for SED complete after 6.89 secs total.
#> Consensus clustering complete after 6.94 secs total.
#> MakeClusterList complete after 6.95 secs total.
