...
#> Euclidean t-SNE calculation complete after 3.47 secs total.
#> Combined distance calculation complete after 3.47 secs total.
#> SED t-SNE calculation complete after 5.08 secs total.

#> Clustering for Euclidean complete after 5.92 secs total.

#> Clustering for Spearman complete after 5.92 secs total.

#> Clustering for SED complete after 5.92 secs total.
#> Consensus clustering complete after 5.97 secs total.
#> MakeClusterList complete after 5.97 secs total.
