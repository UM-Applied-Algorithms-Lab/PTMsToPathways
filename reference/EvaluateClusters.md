...
#> Clustering for Spearman complete after 6.18 secs total.

#> Clustering for SED complete after 6.19 secs total.
#> Consensus clustering complete after 6.23 secs total.
#> MakeClusterList complete after 6.23 secs total.
