...
#> Euclidean t-SNE calculation complete after 3.65 secs total.
#> Combined distance calculation complete after 3.65 secs total.
#> SED t-SNE calculation complete after 5.38 secs total.

#> Clustering for Euclidean complete after 6.21 secs total.

#> Clustering for Spearman complete after 6.22 secs total.

#> Clustering for SED complete after 6.22 secs total.
#> Consensus clustering complete after 6.27 secs total.
#> MakeClusterList complete after 6.27 secs total.
