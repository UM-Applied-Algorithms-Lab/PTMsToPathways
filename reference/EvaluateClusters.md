...
#> Euclidean t-SNE calculation complete after 3.74 secs total.
#> Combined distance calculation complete after 3.74 secs total.
#> SED t-SNE calculation complete after 5.52 secs total.

#> Clustering for Euclidean complete after 6.36 secs total.

#> Clustering for Spearman complete after 6.37 secs total.

#> Clustering for SED complete after 6.38 secs total.
#> Consensus clustering complete after 6.42 secs total.
#> MakeClusterList complete after 6.42 secs total.
