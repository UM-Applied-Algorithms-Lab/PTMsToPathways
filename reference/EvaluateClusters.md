...
#> Spearman correlation calculation complete after 0.15 secs total.
#> Spearman t-SNE calculation complete after 1.18 secs total.
#> Euclidean distance calculation complete after 1.18 secs total.
#> Euclidean t-SNE calculation complete after 2.35 secs total.
#> Combined distance calculation complete after 2.35 secs total.
#> SED t-SNE calculation complete after 3.45 secs total.

#> Clustering for Euclidean complete after 4.24 secs total.

#> Clustering for Spearman complete after 4.25 secs total.

#> Clustering for SED complete after 4.25 secs total.
#> Consensus clustering complete after 4.28 secs total.
#> MakeClusterList complete after 4.28 secs total.
