...
#> Spearman t-SNE calculation complete after 1.4 secs total.
#> Euclidean distance calculation complete after 1.4 secs total.
#> Euclidean t-SNE calculation complete after 2.73 secs total.
#> Combined distance calculation complete after 2.73 secs total.
#> SED t-SNE calculation complete after 4 secs total.

#> Clustering for Euclidean complete after 4.81 secs total.

#> Clustering for Spearman complete after 4.82 secs total.

#> Clustering for SED complete after 4.82 secs total.
#> Consensus clustering complete after 4.86 secs total.
#> MakeClusterList complete after 4.86 secs total.
