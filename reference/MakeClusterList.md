...
#> Spearman correlation calculation complete after 0.36 secs total.
#> Spearman t-SNE calculation complete after 1.55 secs total.
#> Euclidean distance calculation complete after 1.55 secs total.
#> Euclidean t-SNE calculation complete after 2.71 secs total.
#> Combined distance calculation complete after 2.71 secs total.
#> SED t-SNE calculation complete after 4 secs total.

#> Clustering for Euclidean complete after 4.01 secs total.

#> Clustering for Spearman complete after 4.01 secs total.

#> Clustering for SED complete after 4.01 secs total.
#> Consensus clustering complete after 4.02 secs total.
#> MakeClusterList complete after 4.02 secs total.
