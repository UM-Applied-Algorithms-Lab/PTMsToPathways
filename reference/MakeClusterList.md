...
#> Euclidean t-SNE calculation complete after 3.6 secs total.
...
#> Clustering for Spearman complete after 5.38 secs total.

#> Clustering for SED complete after 5.38 secs total.
#> Consensus clustering complete after 5.39 secs total.
#> MakeClusterList complete after 5.39 secs total.
