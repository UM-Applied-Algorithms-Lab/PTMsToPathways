...
#> Euclidean t-SNE calculation complete after 4.03 secs total.
#> Combined distance calculation complete after 4.03 secs total.
#> SED t-SNE calculation complete after 5.93 secs total.

#> Clustering for Euclidean complete after 6.91 secs total.

#> Clustering for Spearman complete after 6.91 secs total.

#> Clustering for SED complete after 6.92 secs total.
#> Consensus clustering complete after 6.96 secs total.
#> MakeClusterList complete after 6.96 secs total.
