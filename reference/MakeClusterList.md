...
#> Euclidean t-SNE calculation complete after 2.39 secs total.
#> Combined distance calculation complete after 2.39 secs total.
#> SED t-SNE calculation complete after 3.51 secs total.

#> Clustering for Euclidean complete after 3.51 secs total.

#> Clustering for Spearman complete after 3.52 secs total.

#> Clustering for SED complete after 3.52 secs total.
#> Consensus clustering complete after 3.52 secs total.
#> MakeClusterList complete after 3.52 secs total.
