...
#> Spearman t-SNE calculation complete after 1.81 secs total.
#> Euclidean distance calculation complete after 1.81 secs total.
#> Euclidean t-SNE calculation complete after 3.36 secs total.
#> Combined distance calculation complete after 3.37 secs total.
#> SED t-SNE calculation complete after 5.09 secs total.

#> Clustering for Euclidean complete after 5.1 secs total.

#> Clustering for Spearman complete after 5.1 secs total.

#> Clustering for SED complete after 5.1 secs total.
#> Consensus clustering complete after 5.11 secs total.
#> MakeClusterList complete after 5.11 secs total.
