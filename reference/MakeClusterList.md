...
#> Clustering for Euclidean complete after 6.77 secs total.

#> Clustering for Spearman complete after 6.78 secs total.

#> Clustering for SED complete after 6.78 secs total.
#> Consensus clustering complete after 6.82 secs total.
#> MakeClusterList complete after 6.83 secs total.
