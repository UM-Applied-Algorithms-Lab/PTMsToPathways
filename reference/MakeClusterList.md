...
#> SED t-SNE calculation complete after 5.14 secs total.

#> Clustering for Euclidean complete after 5.99 secs total.

#> Clustering for Spearman complete after 6 secs total.

#> Clustering for SED complete after 6 secs total.
#> Consensus clustering complete after 6.04 secs total.
