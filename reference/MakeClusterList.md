...
#> Euclidean t-SNE calculation complete after 3.96 secs total.
#> Combined distance calculation complete after 3.96 secs total.
#> SED t-SNE calculation complete after 5.83 secs total.

#> Clustering for Euclidean complete after 6.56 secs total.

#> Clustering for Spearman complete after 6.57 secs total.

#> Clustering for SED complete after 6.58 secs total.
#> Consensus clustering complete after 6.63 secs total.
#> MakeClusterList complete after 6.63 secs total.
