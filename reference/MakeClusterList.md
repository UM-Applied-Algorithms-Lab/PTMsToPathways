...
#> Spearman t-SNE calculation complete after 1.85 secs total.
#> Euclidean distance calculation complete after 1.85 secs total.
#> Euclidean t-SNE calculation complete after 3.7 secs total.
#> Combined distance calculation complete after 3.7 secs total.
#> SED t-SNE calculation complete after 5.44 secs total.

#> Clustering for Euclidean complete after 6.28 secs total.

#> Clustering for Spearman complete after 6.29 secs total.

#> Clustering for SED complete after 6.29 secs total.
#> Consensus clustering complete after 6.33 secs total.
#> MakeClusterList complete after 6.33 secs total.
