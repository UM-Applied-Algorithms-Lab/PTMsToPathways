...
#> Clustering for Euclidean complete after 5.97 secs total.

#> Clustering for Spearman complete after 5.97 secs total.

#> Clustering for SED complete after 5.98 secs total.
#> Consensus clustering complete after 6.01 secs total.
#> MakeClusterList complete after 6.02 secs total.
