...
#> Euclidean t-SNE calculation complete after 4.01 secs total.
#> Combined distance calculation complete after 4.01 secs total.
#> SED t-SNE calculation complete after 5.9 secs total.

#> Clustering for Euclidean complete after 6.73 secs total.

#> Clustering for Spearman complete after 6.73 secs total.

#> Clustering for SED complete after 6.74 secs total.
#> Consensus clustering complete after 6.78 secs total.
#> MakeClusterList complete after 6.78 secs total.
