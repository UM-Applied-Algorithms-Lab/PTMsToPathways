...
#> Spearman t-SNE calculation complete after 2.02 secs total.
#> Euclidean distance calculation complete after 2.02 secs total.
#> Euclidean t-SNE calculation complete after 3.61 secs total.
#> Combined distance calculation complete after 3.61 secs total.
#> SED t-SNE calculation complete after 5.38 secs total.

#> Clustering for Euclidean complete after 5.38 secs total.

#> Clustering for Spearman complete after 5.39 secs total.

#> Clustering for SED complete after 5.39 secs total.
#> Consensus clustering complete after 5.39 secs total.
#> MakeClusterList complete after 5.4 secs total.
