...
#> Euclidean t-SNE calculation complete after 3.68 secs total.
#> Combined distance calculation complete after 3.68 secs total.
#> SED t-SNE calculation complete after 5.39 secs total.

#> Clustering for Euclidean complete after 6.18 secs total.

#> Clustering for Spearman complete after 6.19 secs total.

#> Clustering for SED complete after 6.19 secs total.
#> Consensus clustering complete after 6.37 secs total.
#> MakeClusterList complete after 6.37 secs total.
