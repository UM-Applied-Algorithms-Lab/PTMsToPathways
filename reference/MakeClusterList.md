...
#> Spearman t-SNE calculation complete after 1.39 secs total.
#> Euclidean distance calculation complete after 1.39 secs total.
...
#> Clustering for Euclidean complete after 4.64 secs total.

#> Clustering for Spearman complete after 4.65 secs total.

#> Clustering for SED complete after 4.65 secs total.
#> Consensus clustering complete after 4.84 secs total.
#> MakeClusterList complete after 4.84 secs total.
