...
#> Clustering for Euclidean complete after 6.11 secs total.

#> Clustering for Spearman complete after 6.12 secs total.

#> Clustering for SED complete after 6.12 secs total.
#> Consensus clustering complete after 6.16 secs total.
#> MakeClusterList complete after 6.16 secs total.
