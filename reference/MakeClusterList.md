...
#> Spearman t-SNE calculation complete after 1.74 secs total.
#> Euclidean distance calculation complete after 1.74 secs total.
#> Euclidean t-SNE calculation complete after 3.28 secs total.
#> Combined distance calculation complete after 3.28 secs total.
#> SED t-SNE calculation complete after 4.72 secs total.

#> Clustering for Euclidean complete after 5.52 secs total.

#> Clustering for Spearman complete after 5.53 secs total.

#> Clustering for SED complete after 5.53 secs total.
#> Consensus clustering complete after 5.57 secs total.
#> MakeClusterList complete after 5.57 secs total.
