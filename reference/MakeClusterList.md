...
#> SED t-SNE calculation complete after 4.88 secs total.

#> Clustering for Euclidean complete after 4.88 secs total.

#> Clustering for Spearman complete after 4.89 secs total.

#> Clustering for SED complete after 4.89 secs total.
#> Consensus clustering complete after 4.89 secs total.
#> MakeClusterList complete after 4.89 secs total.
