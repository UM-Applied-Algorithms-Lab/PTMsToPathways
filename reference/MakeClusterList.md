...
#> Spearman t-SNE calculation complete after 1.98 secs total.
#> Euclidean distance calculation complete after 1.98 secs total.
...
#> Clustering for Euclidean complete after 5.33 secs total.

#> Clustering for Spearman complete after 5.34 secs total.

#> Clustering for SED complete after 5.34 secs total.
#> Consensus clustering complete after 5.34 secs total.
#> MakeClusterList complete after 5.34 secs total.
