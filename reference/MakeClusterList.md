...
#> Spearman t-SNE calculation complete after 2.03 secs total.
#> Euclidean distance calculation complete after 2.03 secs total.
#> Euclidean t-SNE calculation complete after 4.02 secs total.
#> Combined distance calculation complete after 4.02 secs total.
#> SED t-SNE calculation complete after 5.95 secs total.

#> Clustering for Euclidean complete after 6.86 secs total.

#> Clustering for Spearman complete after 6.86 secs total.

#> Clustering for SED complete after 6.87 secs total.
#> Consensus clustering complete after 6.91 secs total.
#> MakeClusterList complete after 6.91 secs total.
