...
#> Spearman t-SNE calculation complete after 1.93 secs total.
#> Euclidean distance calculation complete after 1.93 secs total.
#> Euclidean t-SNE calculation complete after 3.85 secs total.
#> Combined distance calculation complete after 3.85 secs total.
#> SED t-SNE calculation complete after 5.68 secs total.

#> Clustering for Euclidean complete after 6.46 secs total.

#> Clustering for Spearman complete after 6.46 secs total.

#> Clustering for SED complete after 6.47 secs total.
#> Consensus clustering complete after 6.51 secs total.
#> MakeClusterList complete after 6.51 secs total.
