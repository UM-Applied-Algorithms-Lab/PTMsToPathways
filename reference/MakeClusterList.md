...
#> Spearman t-SNE calculation complete after 1.9 secs total.
#> Euclidean distance calculation complete after 1.9 secs total.
#> Euclidean t-SNE calculation complete after 3.55 secs total.
#> Combined distance calculation complete after 3.55 secs total.
#> SED t-SNE calculation complete after 5.13 secs total.

#> Clustering for Euclidean complete after 6.03 secs total.

#> Clustering for Spearman complete after 6.03 secs total.

#> Clustering for SED complete after 6.04 secs total.
#> Consensus clustering complete after 6.08 secs total.
#> MakeClusterList complete after 6.08 secs total.
