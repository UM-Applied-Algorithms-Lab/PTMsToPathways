...
#> Clustering for Euclidean complete after 6 secs total.

#> Clustering for Spearman complete after 6.01 secs total.

#> Clustering for SED complete after 6.01 secs total.
#> Consensus clustering complete after 6.05 secs total.
#> MakeClusterList complete after 6.05 secs total.
