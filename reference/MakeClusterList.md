...
#> Clustering for Spearman complete after 5.37 secs total.

#> Clustering for SED complete after 5.38 secs total.
#> Consensus clustering complete after 5.38 secs total.
#> MakeClusterList complete after 5.38 secs total.
