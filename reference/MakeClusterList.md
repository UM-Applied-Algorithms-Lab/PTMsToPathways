...
#> Spearman correlation calculation complete after 0.32 secs total.
#> Spearman t-SNE calculation complete after 1.59 secs total.
#> Euclidean distance calculation complete after 1.6 secs total.
#> Euclidean t-SNE calculation complete after 2.86 secs total.
#> Combined distance calculation complete after 2.86 secs total.
#> SED t-SNE calculation complete after 4.21 secs total.

#> Clustering for Euclidean complete after 4.22 secs total.

#> Clustering for Spearman complete after 4.22 secs total.

#> Clustering for SED complete after 4.22 secs total.
#> Consensus clustering complete after 4.23 secs total.
#> MakeClusterList complete after 4.23 secs total.
