...
#> Combined distance calculation complete after 3.4 secs total.
#> SED t-SNE calculation complete after 5.13 secs total.

#> Clustering for Euclidean complete after 5.14 secs total.

#> Clustering for Spearman complete after 5.14 secs total.

#> Clustering for SED complete after 5.15 secs total.
#> Consensus clustering complete after 5.15 secs total.
#> MakeClusterList complete after 5.15 secs total.
