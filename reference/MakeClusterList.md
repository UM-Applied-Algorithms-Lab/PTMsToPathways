...
#> Spearman correlation calculation complete after 0.39 secs total.
#> Spearman t-SNE calculation complete after 1.91 secs total.
#> Euclidean distance calculation complete after 1.91 secs total.
#> Euclidean t-SNE calculation complete after 3.39 secs total.
#> Combined distance calculation complete after 3.39 secs total.
#> SED t-SNE calculation complete after 5.05 secs total.

#> Clustering for Euclidean complete after 5.05 secs total.

#> Clustering for Spearman complete after 5.06 secs total.

#> Clustering for SED complete after 5.06 secs total.
#> Consensus clustering complete after 5.06 secs total.
#> MakeClusterList complete after 5.07 secs total.
