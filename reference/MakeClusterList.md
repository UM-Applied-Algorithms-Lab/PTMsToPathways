...
#> Combined distance calculation complete after 3.98 secs total.
#> SED t-SNE calculation complete after 5.85 secs total.

#> Clustering for Euclidean complete after 6.68 secs total.

#> Clustering for Spearman complete after 6.69 secs total.

#> Clustering for SED complete after 6.69 secs total.
#> Consensus clustering complete after 6.73 secs total.
#> MakeClusterList complete after 6.73 secs total.
