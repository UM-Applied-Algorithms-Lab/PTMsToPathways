...
#> Spearman t-SNE calculation complete after 1.86 secs total.
#> Euclidean distance calculation complete after 1.86 secs total.
#> Euclidean t-SNE calculation complete after 3.51 secs total.
#> Combined distance calculation complete after 3.51 secs total.
#> SED t-SNE calculation complete after 5.06 secs total.

#> Clustering for Euclidean complete after 6.09 secs total.

#> Clustering for Spearman complete after 6.09 secs total.

#> Clustering for SED complete after 6.09 secs total.
#> Consensus clustering complete after 6.14 secs total.
#> MakeClusterList complete after 6.14 secs total.
