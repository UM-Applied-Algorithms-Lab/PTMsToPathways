...
#> Spearman correlation calculation complete after 0.44 secs total.
#> Spearman t-SNE calculation complete after 1.96 secs total.
#> Euclidean distance calculation complete after 1.96 secs total.
#> Euclidean t-SNE calculation complete after 3.44 secs total.
#> Combined distance calculation complete after 3.44 secs total.
#> SED t-SNE calculation complete after 5.12 secs total.

#> Clustering for Euclidean complete after 5.12 secs total.

#> Clustering for Spearman complete after 5.13 secs total.

#> Clustering for SED complete after 5.13 secs total.
#> Consensus clustering complete after 5.14 secs total.
#> MakeClusterList complete after 5.14 secs total.
