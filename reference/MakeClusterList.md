...
#> Euclidean t-SNE calculation complete after 4 secs total.
#> Combined distance calculation complete after 4 secs total.
#> SED t-SNE calculation complete after 5.88 secs total.

#> Clustering for Euclidean complete after 6.99 secs total.

#> Clustering for Spearman complete after 6.99 secs total.

#> Clustering for SED complete after 7 secs total.
#> Consensus clustering complete after 7.04 secs total.
#> MakeClusterList complete after 7.04 secs total.
