...
#> Spearman correlation calculation complete after 0.19 secs total.
#> Spearman t-SNE calculation complete after 1.37 secs total.
#> Euclidean distance calculation complete after 1.37 secs total.
#> Euclidean t-SNE calculation complete after 2.52 secs total.
#> Combined distance calculation complete after 2.53 secs total.
#> SED t-SNE calculation complete after 3.84 secs total.

#> Clustering for Euclidean complete after 3.84 secs total.

#> Clustering for Spearman complete after 3.85 secs total.

#> Clustering for SED complete after 3.85 secs total.
#> Consensus clustering complete after 3.85 secs total.
#> MakeClusterList complete after 3.85 secs total.
