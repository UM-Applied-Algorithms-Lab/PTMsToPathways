...
#> Euclidean t-SNE calculation complete after 3.57 secs total.
#> Combined distance calculation complete after 3.57 secs total.
#> SED t-SNE calculation complete after 5.15 secs total.

#> Clustering for Euclidean complete after 6.06 secs total.

#> Clustering for Spearman complete after 6.06 secs total.

#> Clustering for SED complete after 6.07 secs total.
#> Consensus clustering complete after 6.11 secs total.
#> MakeClusterList complete after 6.11 secs total.
