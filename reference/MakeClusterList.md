...
#> Euclidean distance calculation complete after 1.78 secs total.
#> Euclidean t-SNE calculation complete after 3.54 secs total.
#> Combined distance calculation complete after 3.54 secs total.
#> SED t-SNE calculation complete after 5.23 secs total.

#> Clustering for Euclidean complete after 6.09 secs total.

#> Clustering for Spearman complete after 6.1 secs total.

#> Clustering for SED complete after 6.1 secs total.
