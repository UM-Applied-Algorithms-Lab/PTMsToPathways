...
#> Spearman t-SNE calculation complete after 1.92 secs total.
#> Euclidean distance calculation complete after 1.92 secs total.
#> Euclidean t-SNE calculation complete after 3.76 secs total.
#> Combined distance calculation complete after 3.76 secs total.
#> SED t-SNE calculation complete after 5.5 secs total.

#> Clustering for Euclidean complete after 6.4 secs total.

#> Clustering for Spearman complete after 6.4 secs total.

#> Clustering for SED complete after 6.41 secs total.
#> Consensus clustering complete after 6.45 secs total.
#> MakeClusterList complete after 6.45 secs total.
