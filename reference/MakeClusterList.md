...
#> Clustering for Euclidean complete after 6.08 secs total.

#> Clustering for Spearman complete after 6.08 secs total.

#> Clustering for SED complete after 6.09 secs total.
#> Consensus clustering complete after 6.13 secs total.
#> MakeClusterList complete after 6.13 secs total.
