...
#> Clustering for Euclidean complete after 6.67 secs total.

#> Clustering for Spearman complete after 6.68 secs total.

#> Clustering for SED complete after 6.68 secs total.
#> Consensus clustering complete after 6.72 secs total.
#> MakeClusterList complete after 6.72 secs total.
