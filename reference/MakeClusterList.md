...
#> Euclidean t-SNE calculation complete after 3.31 secs total.
#> Combined distance calculation complete after 3.31 secs total.
#> SED t-SNE calculation complete after 4.98 secs total.

#> Clustering for Euclidean complete after 4.99 secs total.

#> Clustering for Spearman complete after 4.99 secs total.

#> Clustering for SED complete after 4.99 secs total.
#> Consensus clustering complete after 5 secs total.
#> MakeClusterList complete after 5 secs total.
