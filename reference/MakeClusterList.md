...
#> Spearman t-SNE calculation complete after 1.83 secs total.
#> Euclidean distance calculation complete after 1.83 secs total.
#> Euclidean t-SNE calculation complete after 3.4 secs total.
#> Combined distance calculation complete after 3.41 secs total.
#> SED t-SNE calculation complete after 5.15 secs total.

#> Clustering for Euclidean complete after 5.15 secs total.

#> Clustering for Spearman complete after 5.16 secs total.

#> Clustering for SED complete after 5.16 secs total.
#> Consensus clustering complete after 5.16 secs total.
#> MakeClusterList complete after 5.17 secs total.
