...
#> Euclidean t-SNE calculation complete after 3.92 secs total.
#> Combined distance calculation complete after 3.92 secs total.
#> SED t-SNE calculation complete after 5.78 secs total.

#> Clustering for Euclidean complete after 6.56 secs total.

#> Clustering for Spearman complete after 6.57 secs total.

#> Clustering for SED complete after 6.57 secs total.
#> Consensus clustering complete after 6.61 secs total.
#> MakeClusterList complete after 6.61 secs total.
