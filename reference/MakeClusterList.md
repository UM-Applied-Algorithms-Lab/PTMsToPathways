...
#> SED t-SNE calculation complete after 5.74 secs total.

#> Clustering for Euclidean complete after 6.5 secs total.

#> Clustering for Spearman complete after 6.5 secs total.

#> Clustering for SED complete after 6.51 secs total.
#> Consensus clustering complete after 6.55 secs total.
#> MakeClusterList complete after 6.55 secs total.
