...
#> Clustering for Euclidean complete after 5.35 secs total.

#> Clustering for Spearman complete after 5.35 secs total.

#> Clustering for SED complete after 5.36 secs total.
#> Consensus clustering complete after 5.36 secs total.
#> MakeClusterList complete after 5.36 secs total.
