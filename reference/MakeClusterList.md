...
#> Spearman correlation calculation complete after 0.5 secs total.
#> Spearman t-SNE calculation complete after 2.15 secs total.
#> Euclidean distance calculation complete after 2.15 secs total.
#> Euclidean t-SNE calculation complete after 3.79 secs total.
#> Combined distance calculation complete after 3.79 secs total.
#> SED t-SNE calculation complete after 5.6 secs total.

#> Clustering for Euclidean complete after 5.6 secs total.

#> Clustering for Spearman complete after 5.61 secs total.

#> Clustering for SED complete after 5.61 secs total.
#> Consensus clustering complete after 5.62 secs total.
#> MakeClusterList complete after 5.62 secs total.
