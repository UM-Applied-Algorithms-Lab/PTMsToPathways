...
writeLines(""); writeLines("Testing common clusters algorithm") 
...
writeLines(""); writeLines("Testing cocluster network")
...
writeLines(""); writeLines("--- Finished Correlation Network testing ---")
