...
>> Spearman correlation calculation complete after 14.37 secs total.
>> Spearman t-SNE calculation complete after 43.78 secs total.
>> Euclidean distance calculation complete after 43.83 secs total.
>> Euclidean t-SNE calculation complete after 1.19 mins total.
>> Combined distance calculation complete after 1.19 mins total.
>> SED t-SNE calculation complete after 1.65 mins total.
```

![](plots/unnamed-chunk-9-1.png)

    >> Clustering for Euclidean complete after 1.66 mins total.

![](plots/unnamed-chunk-9-2.png)

    >> Clustering for Spearman complete after 1.67 mins total.

![](plots/unnamed-chunk-9-3.png)

    >> Clustering for SED complete after 1.67 mins total.
    >> Consensus clustering complete after 1.68 mins total.
    >> MakeClusterList complete after 1.68 mins total.
...
>> Making Gene CCCN
>> Gene CCCN complete after 1.98 secs total.
...
>> [1] "Making PCN"
>> [1] "2025-12-08 20:09:54 UTC"
>> [1] "2025-12-08 20:09:54 UTC"
>> [1] Total time: 0.111281633377075
```
