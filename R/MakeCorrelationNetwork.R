...
#' @param filtered.ptm.cor.name The PTM correlation matrix filtered by PTMs that cocluster
...
MakeCorrelationNetwork <- function(clusterlist, ptm.correlation.matrix, keeplength = 2, clusters.name = "clusters.common", filtered.ptm.cor.name = "filtered.ptm.cor", cccn.name = "cccn.matrix"){
