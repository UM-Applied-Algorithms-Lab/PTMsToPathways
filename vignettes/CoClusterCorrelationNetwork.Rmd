...
**Note**: Input automatically pulls from the global environment the outputs from Step 1.  
...
```
#### Description:
This is an optional step that allows you to visual the matrix made in Step 2. Note that this does not affect any future part of the code and is information purely for the sake of the user.

#### To run: save your matrix as a variable with your desired name and keeplength value.
- name <- MakeCorrelationNetwork(keeplength)

####Then run this command with your desired name
- Visualize(name)
