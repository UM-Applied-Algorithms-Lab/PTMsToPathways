...
**Note:** This function, like the ones before it, will pull required data from the global enviroment. 
Requires both a cccn_matrix and a list of PPI edges. Checks all PPI edges to see if their edge weight is equal to the weight of the same edge in the matrix. If it is not, then it will be removed from the list of PPI edges. 
