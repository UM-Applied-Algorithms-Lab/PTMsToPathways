...
gene.cccn.nodes <- CCCN.data[[3]] # List of nodes in the CCCN for gathering PPI data from external databases
...
```{r eval = FALSE}
kinsub.edges <- format.kinsub.table(kinasesubstrate.filename = "Kinase_Substrate_Dataset.txt", gene.cccn.nodes)
