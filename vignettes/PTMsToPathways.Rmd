...
The PTMs2Pathways (P2P) package takes mass spectrometry data of protein
post-translational modifications under different experimental conditions
and uses machine learning to identify PTM clusters that represent
functional modules in cell signaling. The clusters created initially are
then used to identify protein-protein interactions, and interactions
between cell signaling pathways. The tutorial is intended to be a
step-by-step guide to walk users through the process of using
...
This package provides an example data set using 933 ptms and 8
