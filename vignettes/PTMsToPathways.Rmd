...
Next, we look at a piece of the `adj.consensus` table. Ones represent a pair that cluster and zeroes represent a pair that doesn't:
...
network.list <- BuildClusterFilteredNetwork(gene.cccn.edges, stringdb.edges,
                                            genemania.edges = NULL, kinsub.edges,
                                            db.filepaths = c())
