...
```{r eval = FALSE}
network.list <- BuildClusterFilteredNetwork(stringdb.edges, genemania.edges, gene.cccn.edges, db.filepaths = c(), ppi.network.name = "combined.PPIs", cfn.name = "cfn", returndata=TRUE)
...
egfr_transporter.nodes <- make.cytoscape.node.file (egfr_transporter.cfn, funckey, ptmtable, include.ptm.data = TRUE) 
...
```{r eval = FALSE}
GraphCfn(cfn.edges = egfr_transporter.cfn, cfn.nodes = egfr_transporter.nodes, plotcol = "H3122_Crizotinib", Network.title = "CFN", Network.collection = "PTMsToPathways",
         visual.style.name = "PTMsToPathways.style", background.color = "#949494", edge.label.color = '#17202a', node.label.color = '#000000',
         default.font = "Arial", node.font.size = 20, edge.font.size = 8, edge.line.style = 'SOLID',
