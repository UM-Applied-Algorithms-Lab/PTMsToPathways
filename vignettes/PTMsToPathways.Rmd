...
(CCCNs).
>>>>>>> c09a7c454112fc40d2cadacd745e2c9288e336ad
...
(\# = any integer of choice). The variable *toolong* manipulates the
size of the cluster and is set at 3.5. This is recommended as a good
starting point for t-SNE but can be changed as per the researcher’s
discretion. This function may take upwards of an hour to run, so it is
recommended that the output is saved as an RData object which can then
be imported.
