...
gm.edgefile.path <- system.file("extdata", "ex_gm_edgetable.csv", package = "PTMsToPathways")
gm.nodetable.path <- system.file("extdata", "ex_gm_nodetable.csv", package = "PTMsToPathways")
db.nodes_path <- system.file("extdata", "ex_db_nodes.txt", package = "PTMsToPathways")
```
