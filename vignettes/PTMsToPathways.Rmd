...
Make Correlation Network filters a correlation matrix of PTMs by specific PTMs. It groups this PTM correlation matrix by submatrices that are Gene by Gene. By summing these submatrices, it produces a gene by gene cocluster correlation network shows strength of relationships between proteins using the common clusters between the three distance metrics.  
