...
> ptmtable <- read.csv("Pathto/filename.csv") </br>
View(ptmtable)

## Turning PTMs from columns into rownames
If you have one (or multiple) columns that contain parts of PTM names. This is a command for concatenating those columns and turning them into data frame
