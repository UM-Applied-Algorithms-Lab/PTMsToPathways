...
We wrap this query in a function called `GetSTRINGdb.edges`, which queries only for the genes found in clusters 
...
The `GetKinsub.edges` function reads this downloaded data in and
