...
To get started, load the PTMsToPathways package and read the Bioplanet file using the 
built-in P2P function [ReadBioplanetFile()](reference/ReadBioplanetFile.html).
...
```
Then we want to find interactions between the pathway
