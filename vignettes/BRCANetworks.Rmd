...
can be obtained from STRINGdb and GeneMANIA websites as demonstrated in the [Creating Networks vignette](GettingStarted.html).
...
Next, we retrieve kinase-substrate edges, then obain the cluster filtered network, retaining PPIs only for proteins whose PTMs co-cluster, as demonstrated in the [Creating Networks vignette](GettingStarted.html).
