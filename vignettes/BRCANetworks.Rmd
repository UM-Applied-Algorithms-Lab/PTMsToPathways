...
```{r eval = TRUE} 
 newphos$Peptide.Name <- mapply(
   PTMsToPathways::name.peptide, genes = newphos$gene_symbol,
...
# should be 202
```
We can visualize these in a large heatmap that is saved to the disk. To demonstrate,
let's look at the output for the first 3 clusters.
```{r eval = TRUE}
