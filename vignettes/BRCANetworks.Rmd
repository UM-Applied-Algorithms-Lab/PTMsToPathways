...
For PPI edges, the code below demonstrates how to get the STRING-db and GeneMANIA edges from the static downloaded networks provided in "Data_repository_path".
Alternatively, the resulting edges can be loaded from within the package.
